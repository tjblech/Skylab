const CACHE='skylab-shell-v3-preview-faithful';
const SHELL=['./','./index.html','./app.css','./app.js','./manifest.webmanifest','./assets/icon-192.png','./assets/icon-512.png','./assets/art-milkyway.svg','./assets/art-aurora.svg','./assets/art-saturn.svg','./assets/art-meteor.svg','./assets/art-iss.svg','./assets/moon-texture.svg'];
